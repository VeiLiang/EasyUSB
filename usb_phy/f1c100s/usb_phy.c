...
void USBC_CoreRegDump(void)
{
	...
	USBC_SelectActiveEp(1);
	usbprint("USBC_REG_RXMAXP:0x%04x\n",USBC_Readw(USBC_REG_RXMAXP(USBC0_BASE)));
	usbprint("USBC_REG_TXMAXP:0x%04x\n",USBC_Readw(USBC_REG_TXMAXP(USBC0_BASE)));
	usbprint("\n----------------------------------------------\n");
}
